   ...
   text-slate-600 dark:text-white px-20 py-20">
    ...
    <div className="grid gap-6 lg:grid-cols-2">
     ...
     <div>
        ...
        <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium">Token URI</label>
            <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 
        ...
        <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium">Marketing Wallet</label>
            <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 
            text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block 
            w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
        ...
        <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium">Price to mint (ETH)</label>
            <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 
            text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
            block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
