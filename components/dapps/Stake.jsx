  ...
  return (
   ...
   text-slate-600 dark:text-white px-20 py-20">
    ...
    <div className="grid gap-6 lg:grid-cols-2">
     ...
     <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium">Token Address</label>
            ...
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0x1234...abc" required />
        </div>
        <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium">Amount</label>
            <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 
            text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
            block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="100" required />
        </div>
